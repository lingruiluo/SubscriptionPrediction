...
The overall accuracy decreases to `r 0.8679227`, since it classifies more people who did not subscribe into subscribe. However, the false positive rate actually declines to 42.1%, the goal to target potential customers are better achieved without contacting too many clients.
