...
The overall accuracy decreases to `r logit_pred_acc`, since it classifies more people who did not subscribe into subscribe. However, the false positive rate actually declines to 24.8%, the goal to target potential customers are better achieved without contacting too many clients.
